...
def read_off(filepath):
    ...
    """
    # mesh = trimesh.exchange.off.load_off(open(filepath,'rb'))
    # vert = mesh['vertices']
    # face = mesh['faces']
    # return vert, face
...
def read_ply(filepath):
    """
    read a standard .ply file

    Parameters
    -------------------------
    file : path to a '.ply'-format file
    ...
    # face = mesh['faces']
    # return vert, face
    mesh = trimesh.exchange.ply.load_ply(open(filepath,'rb'))
    vert = mesh['vertices']
    face = mesh['faces']
    return vert, face
